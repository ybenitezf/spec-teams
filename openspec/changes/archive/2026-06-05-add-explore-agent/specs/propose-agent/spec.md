...
- **AND** the propose agent deletes `.pi/spec-sessions/explore-add-dark-mode.md` after reading

#### Scenario: Findings file absent — proceeds normally
- **WHEN** dispatched with a change name
- **AND** no findings file exists at `.pi/spec-sessions/explore-<name>.md`
