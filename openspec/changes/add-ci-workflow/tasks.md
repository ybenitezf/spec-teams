...
- [x] 3.1 Push branch to GitHub (branch `add-ci-workflow` pushed with commit b82235d)
...
- [x] 3.4 (Optional) Add CI status badge to README.md: `[![CI](https://github.com/ybenitezf/spec-teams-extension/actions/workflows/ci.yml/badge.svg)](https://github.com/ybenitezf/spec-teams-extension/actions/workflows/ci.yml)`
